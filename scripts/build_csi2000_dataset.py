...
from finfact_io.exports.index_point_in_time import build_csi2000_dataset


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build a point-in-time CSI 2000 data directory from local index data.",
    )
    parser.add_argument(
        "--index-dir",
        type=Path,
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=PROJECT_ROOT / "data" / "csi2000",
        help="Output directory. Defaults to ./data/csi2000.",
    )
