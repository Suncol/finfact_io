...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build a point-in-time CSI 1000 data directory from local index data.",
    )
    parser.add_argument(
        "--index-dir",
        type=Path,
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=PROJECT_ROOT / "data" / "csi1000",
        help="Output directory. Defaults to ./data/csi1000.",
    )
